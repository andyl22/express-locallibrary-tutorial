...
exports.genre_list = function(req, res) {
    ...
    .exec(function(error, genre_list) {
        ...
        res.render('genre', { title: "Genres", genre_list: genre_list })
    })
};
...
exports.genre_delete_get = function(req, res, next) {
  ...
  function(err, results){
    if(err) {return next(err)};
    res.render('genre_delete', {title: `Genre: ${results.genre.name}`, books: results.books, genreid:req.params.id});
  })
};
...
exports.genre_update_post = [
  ...
  .isAlphanumeric().trim().withMessage('Name has non-alphanumeric characters.'),
